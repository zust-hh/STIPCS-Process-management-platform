...
$sql="SELECT * FROM project WHERE position='0' AND isOpen = '1' ORDER BY `project`.`begin_time` DESC LIMIT ".(($page-1)*5).",5";
...
$total_sql="SELECT * FROM project WHERE position='0'";
...
if ($page>1){
	$pagebanner.="<li><a href='javascript:void(0)' onclick='ajx3(1)'>首页</a></li>";
	$pagebanner.="<li><a href='javascript:void(0)' onclick='ajx3(".($page-1).")'>上一页</a></li>";
}
...
for($i=$start;$i<=$end;$i++)
	{
		$pagebanner.="<li><a href='javascript:void(0)' onclick='ajx3(".$i.")'>".$i."</a></li>";
	}
...
if ($page<$total_pages) {
	$pagebanner.="<li><a href='javascript:void(0)' onclick='ajx3(".($page+1).")'>下一页</a></li>";
	$pagebanner.="<li><a href='javascript:void(0)' onclick='ajx3(".$total_pages.")'>尾页</a></li>";
}
